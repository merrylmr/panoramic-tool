<script lang="ts">
import type {Doc, Pos, Hot, menuItem} from '@/custom_types/index'
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const initCamera = (element: any, data: Scene) => {
      const width = element.clientWidth;
      const height = element.clientHeight;
      camera = new THREE.PerspectiveCamera(data.params.fov, width / height, data.params.near, data.params.far);
    ...
    const initContent = async (data: Scene) => {
